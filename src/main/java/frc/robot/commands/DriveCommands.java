...
public class DriveCommands {
  ...
  private static final double ANGLE_MAX_VELOCITY = 10.0; // rad/s — approx robot max angular speed
  private static final double ANGLE_MAX_ACCELERATION = 8.0; // rad/s²
            ...
            Commands.run(
                ...
                .finallyDo(
                    () -> {
                      ...
                      double wheelRadius = (state.gyroDelta * Constants.DriveConstants.driveBaseRadius) / wheelDelta;
